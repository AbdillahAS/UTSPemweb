  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:red;">
        <div class="container-fluid">
          <a class="navbar-brand" href="http://sik.kd-serang.upi.edu">
          ...
          <div class="navbar navbar-expand-sm" id="navbarNavDropdown">
            <ul class="navbar-nav text-light">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="http://sik.kd-serang.upi.edu/?page_id=31">Kurikulum</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a class="dropdown-item" href="http://sik.kd-serang.upi.edu/?page_id=21">Sejarah</a></li>
                  <li><a class="dropdown-item" href="http://sik.kd-serang.upi.edu/?page_id=23">Visi dan Misi</a></li>
                  <li><a class="dropdown-item" href="http://sik.kd-serang.upi.edu/?page_id=25">Struktur Organisasi</a></li>
                  <li><a class="dropdown-item" href="http://sik.kd-serang.upi.edu/?page_id=27">Pimpinan, Dosen & Staf</a></li>
                  <li><a class="dropdown-item" href="http://sik.kd-serang.upi.edu/?page_id=19">Akreditasi</a></li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="#">SK Syarat Peringkat Akreditasi</a></li>
                    <li><a class="dropdown-item" href="#">Struktur Kurikulum</a></li>
                    <li><a class="dropdown-item" href="#">Rencana Pembelajaran Semester (RPS)</a></li>
                    <li><a class="dropdown-item" href="#">Nilai Perkuliahan</a></li>
                  </ul>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="kontak.php">Kontak</a>
                  </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://sik.kd-serang.upi.edu/?page_id=1666">FAQ</a>
                </li>
              </li>
            </ul>
          </div>
